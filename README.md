...
5. **Proposed PDS interaction matrix:** hardware interlocks, operational constraints and data tagging; seven rules for PrM, camera illumination, ionisation/alignment laser, LCM calibration, PoF and electrical/thermal faults. Limits, scope and recovery remain for owner agreement. [Download the proposed matrix](references/pds-interaction-matrix-v0.1.csv).
