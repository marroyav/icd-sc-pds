...
DAQ and SC shall both set and monitor timing-endpoint variables through the
OPC UA bridge. Configuration, reset and recovery use request/response;
monitoring is published over the board's GbE connection through OPC UA
subscriptions.
...
through the LCM service and OPC UA adapter: both DAQ and SC set and monitor
timing-endpoint variables through OPC UA, with published reset/recovery
acknowledgement and endpoint state, and command arbitration. Recovery shall
remain available during a timing outage.
