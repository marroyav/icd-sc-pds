...
Timing configuration and monitoring use two paths. The GbE CCM interface shall
expose the local controls defined by the endpoint service in \code{daphne-os},
including reset and endpoint address [R4, R5], and publish endpoint status and
timing-SFP I\textsuperscript{2}C status.
...
DAQ and SC shall both access these GbE controls and monitoring through the
OPC UA bridge. Configuration and control use request/response; monitoring is published through
