...
- DAQ and SC both set and monitor timing-endpoint variables through OPC UA. Configuration/reset/recovery use request-response; monitoring is published. LCMs follow the same contract through their own service/OPC UA adapter. Reset acknowledgement, recovery during timing loss, arbitration, published endpoint state and readiness remain required.
...
PDF SHA-256: `a48c0a69dd3c6d30d5acbd274931ef5e0a7e1ea6173cfdb0e2529b0211fb1f89`
